...
public class OrderCartObjectAdapter extends RecyclerView.Adapter<OrderCartObjectAdapter.ViewHolder> {
    ...
    public OrderCartObjectAdapter(List<CartObject> cartObjectList2) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_order_cart_object, viewGroup, false);
